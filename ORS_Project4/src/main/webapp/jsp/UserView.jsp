   ...
   <center>
    ...
    <div align="center">    
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="firstName" placeholder="Enter First Name" size="26" 
                    oninput=" handleLetterInput(this, 'firstNameError', 8)"
						onblur=" handleLetterInput(this, 'firstNameError', 8)"
						value="<%=DataUtility.getStringData(bean.getFirstName())%>"></td>
                    <td style="position: fixed "><font color="red" id="firstNameError">
    ...
    <tr><th style="padding: 3px"></th></tr>          
              ...
              <tr>
                    ...
                    <td><input type="text" name="lastName" placeholder="Enter Last Name" size="26"
                    oninput=" handleLetterInput(this, 'lastNameError', 8)"
						onblur=" handleLetterInput(this, 'lastNameError', 8)"
						value="<%=DataUtility.getStringData(bean.getLastName())%>"></td>
                     <td style="position: fixed"><font  color="red" id="lastNameError"> 
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" placeholder="Enter EmailId" size="26"
                    oninput=" handleLetterInput(this, 'loginError', 8)"
					onblur=" handleLetterInput(this, 'loginError', 8)"
						value="<%=DataUtility.getStringData(bean.getLogin())%>"
                        <%=(bean.getId() > 0)  ?  "readonly" : ""   %>>  </td>
                       <td style="position: fixed"> <font  color="red" id="loginError">
                ...
                <tr>
                    ...
                    <td>
                        <%
                            ...
                            //map.put("transgender", "transgender");
