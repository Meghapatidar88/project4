...
<body>
	...
	<form action="<%=ORSView.USER_LIST_CTL%>" method="post">
		...
		<center>
			...
			<%
				...
				List ulist = (List) request.getAttribute("firstNamee");
			...
			<table width="100%" align="center">
				<tr>
					...
					<%-- </label> <%=HTMLUtility.getList("id", String.valueOf(bean.getFirstName()), ulist)%> --%>
 ...
 --%> &nbsp; <%-- <label>MobileNo</font> :</label>
 					 <input
						...
						<label>dob</font> :
						<%-- </label> <%=HTMLUtility.getList("id", String.valueOf(bean.getDob()), ulist)%><!--  -->
