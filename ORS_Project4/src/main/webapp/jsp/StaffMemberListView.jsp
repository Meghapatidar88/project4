			...
			<table width="100%" align="center">
				<tr>
					...
					<td align="center"><label>FullName</font> :
						...
						<label>JoiningDate</font> :
					</label><input type="text" name="joiningDate" id="udate"
						readonly="readonly" size="25" placeholder="Enter joiningDate"
						value="<%=ServletUtility.getParameter("joiningDate", request)%>">
						
						
					<td align="center"><label>Division</font> :
					</label> <input type="text" name="division" placeholder="Enter division"
			...
			<table width="100%">
				<tr>
					...
					<td align="right"><input type="submit" name="operation"
						value="<%=StaffMemberListCtl.OP_NEXT%>"
