			...
			<table>
				<tr>
					...
					<td><input type="text" name="userId"
						placeholder="Enter User Id" size="26"
				...
				<tr>
					...
					<td><input type="text" name="endDate" id="udate"
				...
				<tr>
					<th align="left">TransactionType<span style="color: red">*</span>
						:
					</th>
					<td>
						<%
							String hlist = HTMLUtility.getList2("transactionType", DataUtility.getStringData(bean.getTransactionType()),
									map);
						%> <%=hlist%>
					</td>
